...
::: tip 一个系统功能优化
公司系统首页是一个`GridView`宫格模块的界面，但是对于这样的一个界面来讲，渲染界面的时间并不会很长；接口返回的数据的耗时也是比较短的，但是整个过程加起来耗时`22s` ；很难想象为什么会
花费这么长时间呢？
:::
...
![GridView分析图](/assets/images/home_gridview.svg)
...
![GridView解决图1](/assets/images/homeGridview_1.png)
![GridView解决图2](/assets/images/homeGridview_2.png)
![GridView解决图3](/assets/images/homeGridview_3.png)
